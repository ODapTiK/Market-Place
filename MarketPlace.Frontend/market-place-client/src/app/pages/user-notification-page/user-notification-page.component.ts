...
@Component({
  ...
  styleUrl: './user-notification-page.component.scss'
})
export class UserNotificationPageComponent implements OnInit, OnDestroy{
    ...
    this.userService.readUserNotification(notificationId).subscribe({
      next: () => {
        ...
        if (notification && !notification.isRead) {
          ...
          this.userService.notifyUserNotificationRead(); 
        }
      },
      error: (err) => {
