...
namespace ProductService
{
    public class ProductControllerTests
    {
        ...
        public async Task GetManufacturerProducts_ShouldReturnOk_WithProducts()
        {
            ...
            // Act
            var result = await _controller.GetManufacturerProducts(manufacturerId);
        ...
        public async Task CreateProductReview_ShouldReturnOk_WithReviewId()
        {
            ...
            // Act
            var result = await _controller.CreateProductReview(createProductReviewDTO);
        ...
        public async Task DeleteProductReview_ShouldReturnOk()
        {
            ...
            // Act
            var result = await _controller.DeleteProductReview(deleteProductReviewDTO);
